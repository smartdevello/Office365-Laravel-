	...
	<div class="row">
		<div class="col-6">
			<div class="card">
				...
				<div class="card-body">
				@foreach($AllNotification as $ALN)
					<a href="{{ $ALN->notification_link }}" target="_blank" onClick="ReadNoti({{ $ALN->notification_id }})"><div class="alert alert-danger">{{ $ALN->notification_text }}</div></a>
				@endforeach
				</div>
			</div>
		</div>
