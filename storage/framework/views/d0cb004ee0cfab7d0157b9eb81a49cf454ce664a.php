...
<body>
	...
	<div style="margin-top: 10px; background-color:#E9FFFF; padding: 10px;">
		...
		<table width="100%" cellpadding="0" cellspaceing="0" border="0">
			...
			<tr>
				<td><b>No Cleaners:</b></td>
				<td><?php echo e(@$Quote->cleaners_no); ?></td>
				<td><?php echo e(@$ServiceObject->NoCleaners); ?></td>
			</tr>
			...
			<tr>
				...
				<td><?php echo e(@$Quote->moving_time); ?> TO <?php echo e($Quote->moving_time_to); ?></td>
			...
			<tr>
				<td><b>Cleaning Date:</b></td>
				<td><?php echo e(@$Quote->cleaning_date); ?></td>
				<td><?php echo e(@$ServiceObject->CleaningDate); ?></td>
			</tr>
...
</html><?php /**PATH /opt/lampp/htdocs/corner/resources/views/ServiceTemplate/PDFView.blade.php ENDPATH**/ ?>