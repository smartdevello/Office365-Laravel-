...
<body>
	<div style="float: left; margin-left: 50px;">
		<div><h2><?php echo e($GetDriverData->name); ?> Invoice</h2></div>
		<div><?php echo e($GetDriverData->address); ?></div>
		<div><?php echo e($GetDriverData->city); ?></div>
		<div><?php echo e($GetDriverData->postcode); ?></div>

		<div><b>Insurance Number :</b> <?php echo e($GetDriverData->national_insurance); ?></div>
		<div><b>Account Name :</b> <?php echo e($GetDriverData->account_name); ?></div>
		<div><b>Sort Code :</b> <?php echo e($GetDriverData->sort_code); ?></div>
		<div><b>Account Number :</b> <?php echo e($GetDriverData->account_number); ?></div>
	</div>
	...
	<h3 style="text-align: center;">Invoice Number: <?php echo e(substr(strtoupper($GetDriverData->name),0, 2)); ?><?php echo e(date("dmY")); ?></h3>
	<div style="text-align: center;">Invoice Date: <?php echo e(date("d.m.Y")); ?></div>
	...
	<div style="text-align: right;"><h3>Grand Total : <?php echo e(number_format($Total + $ExpnTotal, 2)); ?></h3> </div>
</body>
</html><?php /**PATH /opt/lampp/htdocs/corner/resources/views/Salary/SalaryPDF.blade.php ENDPATH**/ ?>