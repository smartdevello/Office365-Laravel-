...
?>		
	...
	function CalculatePrice(){
        ...
        for(k = 0; k < app.PackingData.length; k++){
            if(app.PackingData[k].PackingDate != ""){
        ...
        $(".MovingMovingDate").each(function(){
            MovingDate = $(this).val();
            DeliveryDate = $(this).parents(".MovnRowClass").find(".MovingDeliveryDate").val();
...
<?php /**PATH /var/www/vhosts/cornerstoneremovals.co.uk/dev1.cornerstoneremovals.co.uk/resources/views/personal_move_plan.blade.php ENDPATH**/ ?>