            ...
            <div class="col-lg-12" style="margin-top: 20px;background-color:#E9FFFF;">
                <div style="padding-top:8px;">
					...
					<div class="row">
						...
						<div class="col-4"><?php echo e($Quote->vehicles_no); ?></div>
					...
					<div class="row">
						...
						<div class="col-4"><?php echo e(@$Quote->moving_time); ?></div>
...
</html><?php /**PATH /opt/lampp/htdocs/corner/resources/views/ServiceTemplate/ClientQuoteView.blade.php ENDPATH**/ ?>