...
<div class="container-fluid">
	<?php if($Message != ""): ?>
	<div class="alert alert-danger">Client ID is Required</div>
	<?php
	die;
	?>
	<?php endif; ?>
      ...
      <div class="modal-body">
      	<div class="row">
		      	...
		      	<div class="row">
					 ...
					 <div class="col-6">
					    <div class="form-group">
					        ...
					        <select type="text" class="form-control" name="ClientStatus">
				...
				<div class="row">
					<div class="col-6">
					     <div class="form-group">
					        ...
					        <select type="text" class="form-control" name="ClientAccMngr">
					        	<?php $__currentLoopData = $GetAllAccMng; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $GAM): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					        	<option><?php echo e($GAM->name); ?></option>
					        	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					        </select>
					     </div>
					 </div>
	          ...
	          <div class="form-group">
	            ...
	            <input type="radio" name="AppointmentDuration" checked="" value="1" id="ApntDur1"> <label for="ApntDur1">15 Mint</label> &nbsp; &nbsp;
	            <input type="radio" name="AppointmentDuration" value="2" id="ApntDur2"> <label for="ApntDur2">30 Mint</label> &nbsp; &nbsp;
	            <input type="radio" name="AppointmentDuration" value="3" id="ApntDur3"> <label for="ApntDur3">45 Mint</label> &nbsp; &nbsp;
	            <input type="radio" name="AppointmentDuration" value="4" id="ApntDur4"> <label for="ApntDur4">60 Mint</label>
	          </div>
			...
			<div class="col-6">
	          <div class="form-group">
		        ...
		        <input type="text" class="form-control" name="ClientPickup" id="ClientPickup" value="<?php echo e(base64_decode($ClientData->address)); ?>">
		     </div>
      ...
      <div class="modal-body" id="EditApointment">
      	...
      	<div class="row">
      		<div class="col-6">
      			...
      			<div class="row">
			        ...
			        <input type="text" class="form-control" name="ClientName" v-model="ClientName">
			 		...
			 		<div class="col-6">
					    <div class="form-group">
					        <label for="recipient-name" class="col-form-label">Status:</label>
					        <select type="text" class="form-control" name="ClientStatus" v-model="ClientStatus">
					        	<option>20 App online confir</option>
					        	<option>20 App in person con</option>
					        	<option>20 App inventorylist</option>
					        </select>
				...
				<div class="row">
      				<div class="col-6">
					    <div class="form-group">
					        <label for="recipient-name" class="col-form-label">Account Manager:</label>
					        <select type="text" class="form-control" name="ClientAccMngr" v-model="ClientAccMngr">
					        	<?php $__currentLoopData = $GetAllAccMng; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $GAM): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					        	<option><?php echo e($GAM->name); ?></option>
					        	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					        </select>
				...
				<div class="form-group">
	            <label class="col-form-label"><b>Duration:</b></label>
	            <input type="radio" name="AppointmentDuration" v-model="AppointmentDuration" checked="" value="1" id="ApntDur11"> <label for="ApntDur11">15 Mint</label> &nbsp; &nbsp;
	            <input type="radio" name="AppointmentDuration" v-model="AppointmentDuration" value="2" id="ApntDur21"> <label for="ApntDur21">30 Mint</label> &nbsp; &nbsp;
	            <input type="radio" name="AppointmentDuration" v-model="AppointmentDuration" value="3" id="ApntDur31"> <label for="ApntDur31">45 Mint</label> &nbsp; &nbsp;
	            <input type="radio" name="AppointmentDuration" v-model="AppointmentDuration" value="4" id="ApntDur41"> <label for="ApntDur41">60 Mint</label>
	          </div>
		    ...
		    <div class="col-6">
		        <div class="form-group">
			        <label for="recipient-name" class="col-form-label">Pickup Address:</label>
			        <input type="text" class="form-control" name="ClientPickup" v-model="ClientPickup1" id="ClientPickup1">
			    </div>
...
function DecodeAddress(){
	...
	geocoder.geocode( { 'address': address}, function(results, status) {
	  if (status == 'OK') {
	    ...
	    var marker = new google.maps.Marker({map: map, position: results[0].geometry.location, draggable:true});
...
function DecodeAddress1(Address){
	...
	geocoder.geocode( { 'address': address}, function(results, status) {
	  if (status == 'OK') {
	    ...
	    var marker = new google.maps.Marker({map: map1, position: results[0].geometry.location, draggable:true});
	    marker.addListener('dragend', function() {
			console.log('Drag ended');
			geocodePosition(marker.getPosition());
		});
...
<?php /**PATH /var/www/vhosts/cornerstoneremovals.co.uk/dev1.cornerstoneremovals.co.uk/resources/views/appointment-calendar.blade.php ENDPATH**/ ?>